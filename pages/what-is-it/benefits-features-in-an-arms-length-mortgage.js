      ...
      <Container>
        ...
        <ul className="mt-4 ml-5 list-disc">
          <li className="mt-2">
            ...
            world economy, you know your investment will earn you X% of interest
            over Y number of months or years.
          </li>
          <li className="mt-2">
            <span className="font-bold">Simplified Retirement Planning</span>
            <br />
            You know precisely HOW MUCH money will be added to your RRSP account
            (unlike floating interest rates or dividends or sales from stocks)
            and WHEN money will be added to your RRSP account.
          </li>
          <li className="mt-2">
            ...
            Investment Terms You know precisely when your investment money is no
            longer being used for a mortgage and is returned to your account.
          </li>
          <li className="mt-2">
            <span className="font-bold">Full Control</span>
            <br /> You, the Investor, have full control over which mortgage you
            want to invest in (unlike mutual funds).
          </li>
          <li className="mt-2">
          ...
          <li className="mt-2">
            ...
            to spend time on this since the trustee, lawyer and borrower do ALL
            the work.
          </li>
          <li className="mt-2">
            <span className="font-bold">No Special Expertise Required </span>
            <br /> No expertise required on your part (the borrower uses a team
            of professionals: lawyer, realtor, accountant), and the trustee is
            well-experienced in this type of transaction.
          </li>
          <li className="mt-2">
            <span className="font-bold">
            ...
            contribution limits for the year—the money is simply being returned
            to you—along with the interest.
          </li>
          <li className="mt-2">
        ...
        <ul className="mt-4 ml-5 list-disc">
          ...
          <li className="mt-2">
            ...
            money) goes to the trustee first, then to the real estate investor’s
            lawyer, then to the seller of the property. The mortgage payments
            are made through the trustee, directly into YOUR RRSP account,
            pulling the money directly from the real estate investor’s bank
            account—you don’t have to collect the payments yourself, this is all
            arranged for you.
          </li>
          <li className="mt-2">
            To protect your privacy, the trustee’s name appears on the title of
            the property as the mortgage holder.
          </li>
          <li className="mt-2">
            The trustee sends you, the account holder (the Investor), a printed
            monthly statement (TD Waterhouse Olympia Trust), as well as access
          ...
          <li className="mt-2">
            ...
            repayment arrangements that’s all that matters—there’s no 3rd party
            who will approve or disapprove the deal. It’s all up to you — YOU
            decide how, when and to whom you want to lend your money. YOU ARE IN
            COMPLETE CONTROL!
          </li>
        </ul>
